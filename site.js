...
export const TopupData = {
  ...
  games: {
    ...
    suicidesquadjusticeleague: { name: "Suicide Squad: Kill the Justice League", item: "PC Steam Key", logo: "https://4kwallpapers.com/images/walls/thumbs_3t/9599.jpg", page: "suicide-squad-kill-the-justice-league.html", description: "Suicide Squad: Kill the Justice League (PC) Steam Key delivered to your active email after payment verification.", noGameId: true, requiresAccountName: true, accountNameLabel: "Steam Account Name", accountNamePlaceholder: "Enter your Steam account name", bundles: [{ label: "Suicide Squad: Kill the Justice League (PC) Steam Key", amount: 2900, originalAmount: 4999 }] },
    indika: { name: "INDIKA", item: "PC Steam Key", logo: "https://wallpapercave.com/wp/wp14259932.jpg", page: "indika.html", description: "INDIKA (PC) Steam Key delivered to your active email after payment verification.", noGameId: true, requiresAccountName: true, accountNameLabel: "Steam Account Name", accountNamePlaceholder: "Enter your Steam account name", bundles: [{ label: "INDIKA (PC) Steam Key", amount: 500, originalAmount: 1100 }] },
    batmanarkhamorigins: { name: "Batman: Arkham Origins", item: "PC Steam Key", logo: "https://www.hdwallpapers.net/previews/batman-arkham-origins-310.jpg", page: "batman-arkham-origins.html", description: "Batman: Arkham Origins Steam Key delivered to your active email after payment verification.", noGameId: true, requiresAccountName: true, accountNameLabel: "Steam Account Name", accountNamePlaceholder: "Enter your Steam account name", bundles: [{ label: "Batman: Arkham Origins Steam Key", amount: 300, originalAmount: 565 }] },

    batmanarkhamcitygoty: { name: "Batman: Arkham City (GOTY)", item: "Steam Key", logo: "https://images6.alphacoders.com/111/thumb-1920-1119858.jpg", page: "batman-arkham-city-goty.html", description: "Batman: Arkham City (GOTY) Steam Key delivered to your active email after payment verification.", noGameId: true, requiresAccountName: true, accountNameLabel: "Steam Account Name", accountNamePlaceholder: "Enter your Steam account name", bundles: [{ label: "Batman: Arkham City (GOTY) Steam Key", amount: 390, originalAmount: 565 }] },
...
export function initCatalogFilters() {
  ...
  const keyCategories = {
    ...
    pragmatadeluxe: "key",
    blackmythwukongdeluxe: { name: "Black Myth: Wukong Deluxe Edition", item: "PC Steam Key", logo: "https://wallpapercave.com/wp/wp15378470.jpg", page: "black-myth-wukong-deluxe-edition.html", description: "Black Myth: Wukong Deluxe Edition (PC) Steam key delivered to your active email after payment verification.", noGameId: true, requiresAccountName: true, accountNameLabel: "Steam Account Name", accountNamePlaceholder: "Enter your Steam account name", bundles: [{ label: "Black Myth: Wukong Deluxe Edition (PC) Steam Key", amount: 4200, originalAmount: 4799 }] },
    suicidesquadjusticeleague: "key",
    indika: "key",
    batmanarkhamorigins: "key",
  ...
  const platformCategories = {
    ...
    blackmythwukongdeluxe: { name: "Black Myth: Wukong Deluxe Edition", item: "PC Steam Key", logo: "https://wallpapercave.com/wp/wp15378470.jpg", page: "black-myth-wukong-deluxe-edition.html", description: "Black Myth: Wukong Deluxe Edition (PC) Steam key delivered to your active email after payment verification.", noGameId: true, requiresAccountName: true, accountNameLabel: "Steam Account Name", accountNamePlaceholder: "Enter your Steam account name", bundles: [{ label: "Black Myth: Wukong Deluxe Edition (PC) Steam Key", amount: 4200, originalAmount: 4799 }] },
    suicidesquadjusticeleague: "steam",
    indika: "steam",
    batmanarkhamorigins: "steam",
